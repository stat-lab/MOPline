...
=head1 SYNOPSIS
  ...
  merge_SV_vcf.6tools_2.pl -s <sample-list-file or a sample name> -rl <read_length> (-nh 1 if sample is a non-human species)
...
foreach my $ID (@ID_list){
    ...
    my $ins_set = "Manta:3=inGAP:$inGAP_ins_mr1 Wham:3=inGAP:$inGAP_ins_mr1 Manta:3=Wham:3 inGAP:$inGAP_ins_mr2 Manta:28";
