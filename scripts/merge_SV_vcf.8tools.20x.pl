...
=head1 SYNOPSIS
  ...
  merge_SV_vcf.8tools.20x.pl -s <sample-list-file or a sample name> -rl <read_length> (-nh 1 if sample is a non-human species)
  output vcf file name: ${sample_name}.Merge.ALL.vcf
  Tools used: GRIDSS, MATCHCLIP, inGAP, CNVnator, Manta, Wham, MELT INSurVeyor
  ...
  Options:
   ...
   --dir or -d <STR>            output directory name, which contains output vcf files [default: Merge_8tools]
...
foreach my $ID (@ID_list){
    ...
    my $ins_set = "Manta:3=inGAP:$inGAP_ins_mr1 Wham:3=inGAP:$inGAP_ins_mr1 Manta:3=Wham:3 INSurVeyor:3=Manta:3 INSurVeyor:3=Wham:3 INSurVeyor:3=inGAP:$inGAP_ins_mr1 inGAP:$inGAP_ins_mr2 Manta:20 MELT:3 INSurVeyor:12";
    ...
    my $dup_set_M = 'CNVnator:3=# inGAP:3=Manta:3 inGAP:3=GRIDSS:6 CNVnator:6';
