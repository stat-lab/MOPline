...
foreach my $ID (@ID_list){
    ...
    system ("$script_dir/merge_SV_calls_multi_tools.pl -st INS -rl $read_length -s $ID -d $ID -t $ins_tools -nh $non_human > $ID/$merge_dir/Merge.INS.3tools.simple.vcf");
    ...
    system ("$script_dir/merge_SV_calls_multi_tools_filter.pl -t INS -ins $ins_set -v $ID/$merge_dir/Merge.INS.3tools.simple.vcf > $ID/$merge_dir/MOP.Merge.INS.3tools.vcf");
    ...
    system ("$script_dir/merge_SV_calls_ALLtype.pl -rl $read_length -v $ID/$merge_dir/MOP.Merge.DEL.6tools.vcf $ID/$merge_dir/MOP.Merge.INS.3tools.vcf $ID/$merge_dir/MOP.Merge.DUP.6tools.vcf $ID/$merge_dir/MOP.Merge.INV.4tools.vcf > $out_vcf");
