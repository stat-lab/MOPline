...
=head1 SYNOPSIS
  ...
  Options:
   ...
   --dir or -d <STR>            output directory name, which contains output vcf files [default: Merge_6tools_2]
...
my @tools = ('GRIDSS', 'MATCHCLIP', 'inGAP', 'CNVnator', 'Manta', 'Wham');
...
foreach my $ID (@ID_list){
    ...
    my $ins_set = "Manta:3=inGAP:$inGAP_ins_mr1 Wham:3=inGAP:$inGAP_ins_mr1 Manta:3=Wham:3 inGAP:$inGAP_ins_mr2 Manta:18";
    ...
    my $del_set_S = 'Manta:3=inGAP:6 Wham:4=Manta:3 Wham:4=inGAP:6 MATCHCLIP:4=inGAP:6 MATCHCLIP:4=Manta:3 MATCHCLIP:4=Wham:4 GRIDSS:6=inGAP:6 GRIDSS:6=Manta:3 GRIDSS:6=MATCHCLIP:4 GRIDSS:6=Wham:4';
    my $del_set_M = 'CNVnator:3=# MATCHCLIP:3=Wham:3 MATCHCLIP:3=inGAP:4 Manta:3=Wham:3 Manta:3=inGAP:4 Manta:3=MATCHCLIP:3 Wham:3=inGAP:4 GRIDSS:6=inGAP:4 GRIDSS:6=MATCHCLIP:3 GRIDSS:6=Wham:3 CNVnator:7'; # inGAP:8 Wham:12';
    ...
    my $dup_set_S = 'MATCHCLIP:3=Manta:3 MATCHCLIP:3=Wham:3 Wham:3=Manta:3 GRIDSS:4=Wham:3 MATCHCLIP:7 GRIDSS:7';
    my $dup_set_M = 'CNVnator:3=# inGAP:5=Manta:3 inGAP:5=GRIDSS:6 CNVnator:6';
    ...
    my $inv_set_L = 'inGAP:4=Manta:3 Wham:5=inGAP:4 Manta:3=Wham:5 GRIDSS:7=Manta:3';
    ...
    system ("$script_dir/merge_SV_calls_ALLtype.pl -rl $read_length -v $IDdir/$merge_dir/MOP.Merge.DEL.6tools.vcf $IDdir/$merge_dir/MOP.Merge.INS.3tools.vcf $IDdir/$merge_dir/MOP.Merge.DUP.6tools.vcf $IDdir/$merge_dir/MOP.Merge.INV.4tools.vcf > $out_vcf");
