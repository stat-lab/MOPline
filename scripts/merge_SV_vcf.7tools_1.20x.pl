...
foreach my $ID (@ID_list){
    ...
    my $ins_set = "Manta:3=inGAP:$inGAP_ins_mr1 Wham:3=inGAP:$inGAP_ins_mr1 Manta:3=Wham:3 INSurVeylor:3=Manta:3 INSurVeylor:3=Wham:3 INSurVeylor:3=inGAP:$inGAP_ins_mr1 inGAP:$inGAP_ins_mr2 Manta:18 MELT:3 INSurVeylor:12";
