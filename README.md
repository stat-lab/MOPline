...
```
Alternatively, a mopline.sif (v1.8.3.1: 1.74 GB) can be obtained [mopline.sif](https://drive.google.com/uc?export=download&id=1q_GOnNi6_bW1RKo-JbMqedi8htP819K4).  
